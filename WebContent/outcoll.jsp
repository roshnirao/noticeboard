...
<body>
<%
int ran=(int)(Math.random() * 439835261);
String rstr=Integer.toString(ran);
session.setAttribute("adi", rstr);
session.setAttribute("rpage", "outcoll1.jsp");
%>
<center>
<br /><br />
<h1>Welcome to Inter college event page..!!</h1>
...
<INPUT TYPE="submit" VALUE="Upload the image" style="background-color:#000; font-family:Times new roman; color:#fff; font-size:20px;">   
 ...
 <form name="f"  action="outcolldb.jsp" method="get" onsubmit="return validateForm()">
