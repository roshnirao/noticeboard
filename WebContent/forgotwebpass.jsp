...
<br /><br />
<h2>
Please enter new password for your account with the Email id : '<%=id%>' .

<form name="c" action="resetwebpass.jsp" method="get" onsubmit="return validateForm()">

<input type="hidden" name="usid" class="resized" size="27" value="<%=id%>" />
<br /><br />

<input type="password" name="pass" class="resized" size="27" maxlength="18" placeholder="New password" />
<br /><br />
