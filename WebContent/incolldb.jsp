...
try{
	...
	PreparedStatement psr = null;
   	        	int updateQuery=0;
   	    	 	...
   	    	 	psr=con.prepareStatement("INSERT INTO incoll VALUES(?,?,?,?,?,?,?)");
   	    	 ...
   	    	 Statement st1=con.createStatement();
	    	 	ResultSet rs1=st1.executeQuery("select * from incoll where ename='"+ename+"'");
    	 	...
    	 	String msgg="Intra college event has been inserted into the database, Notification id is : "+did+", Timestamp is :"+dts+" and Notification info is :"+ename+", please open android app and check, Thank you.";

    	 	smail.sendmail(em,sub,msgg);
    	 	
    	 	out.println("Ok, Intra college event has been inserted into the database..!!, Notification id is : "+did+", Timestamp is :"+dts+" and Notification info is :"+ename+"");
